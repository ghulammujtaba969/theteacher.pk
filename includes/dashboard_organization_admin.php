<!-- Organization Admin Dashboard Content -->
<div class="row gy-4">
    <div class="col-lg-9">
        <!-- Widgets Start -->
        <div class="row gy-4">
        ...
        <!-- Organization Activity Chart Start -->
        <div class="card mt-24">
            <div class="card-body">
                <div class="mb-20 flex-between flex-wrap gap-8">
                    <h4 class="mb-0">Organization Activity Statistics</h4>
                        ...
                        <div class="flex-align flex-wrap gap-16">
                            ...
                            <?php else: ?>
                                ...
                                <div class="flex-align flex-wrap gap-8">
                                    ...
                                    <span class="text-13 text-gray-600">Users</span>
                                </div>
                            <?php endif; ?>
                        </div>
        ...
        <!-- Organization Activity Chart End -->

        <!-- My Schools Start -->
        <div class="card mt-24">
            <div class="card-body">
                <div class="mb-20 flex-between flex-wrap gap-8">
                    <h4 class="mb-0">My Organization Schools</h4>
                    <a href="schools.php" class="text-13 fw-medium text-main-600 hover-text-decoration-underline">View All</a>
                </div>
                
                <?php 
                try {
                    $org_schools_query = "SELECT * FROM schools WHERE organization_id = ? AND status = 'active' ORDER BY created_at DESC LIMIT 3";
                    $org_schools_stmt = $pdo->prepare($org_schools_query);
                    $org_schools_stmt->execute([$current_user['organization_id']]);
                    $organization_schools = $org_schools_stmt->fetchAll(PDO::FETCH_ASSOC);
                } catch (Exception $e) {
                ...
                <div class="row g-20">
                    <?php if (!empty($organization_schools)): ?>
                        <?php foreach ($organization_schools as $school): ?>
                                ...
                                <div class="card-body p-16">
                                    <div class="flex-align gap-8 mb-16">
                                        ...
                                        <div>
                                            ...
                                            <span class="text-13 text-gray-400">School</span>
                                        </div>
                                    </div>
                                    <p class="text-13 text-gray-600 mb-16"><?php echo htmlspecialchars(substr($school['description'] ?? '', 0, 80)) . (strlen($school['description'] ?? '') > 80 ? '...' : ''); ?></p>
                                    <div class="flex-between gap-8">
                                        <small class="text-gray-400">Created: <?php echo date('M d, Y', strtotime($school['created_at'])); ?></small>
                                        <a href="schools.php?id=<?php echo $school['id']; ?>" class="btn btn-outline-main btn-sm rounded-pill">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php else: ?>
                        <div class="col-12">
                            <p class="text-center text-gray-500">No schools found in your organization.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row g-20">
                    <div class="col-lg-3 col-sm-6">
                        <a href="schools.php?action=add" class="btn btn-main w-100 rounded-pill py-12">
                            <i class="ph ph-graduation-cap me-2"></i>Add School
                        </a>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <a href="users.php?action=add&role=school_admin" class="btn btn-outline-main w-100 rounded-pill py-12">
                            <i class="ph ph-user-gear me-2"></i>Add School Admin
                        </a>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <a href="users.php?action=add&role=teacher" class="btn btn-outline-main w-100 rounded-pill py-12">
    ...
    <div class="col-lg-3">
        ...
        <!-- Organization Activities Start -->
        <div class="card mt-24">
            <div class="card-body">
                <div class="mb-20 flex-between flex-wrap gap-8">
                    <h4 class="mb-0">Organization Activities</h4>
                    <a href="users.php" class="text-13 fw-medium text-main-600 hover-text-decoration-underline">View All Users</a>
                </div>
                ...
                <div class="p-xl-4 py-16 px-12 flex-between gap-8 rounded-8 border border-gray-100 hover-border-gray-200 transition-1 mb-16">
                    <div class="flex-align flex-wrap gap-8">
                        ...
                        <div>
                            ...
                            <span class="text-13 text-gray-400"><?php echo $stats['schools']; ?> schools in organization</span>
                        </div>
                    </div>
                ...
                <div class="p-xl-4 py-16 px-12 flex-between gap-8 rounded-8 border border-gray-100 hover-border-gray-200 transition-1 mb-16">
                    <div class="flex-align flex-wrap gap-8">
                        ...
                        <div>
                            ...
                            <span class="text-13 text-gray-400"><?php echo $stats['users']; ?> users in organization</span>
                        </div>
                    </div>
                ...
                <div class="p-xl-4 py-16 px-12 flex-between gap-8 rounded-8 border border-gray-100 hover-border-gray-200 transition-1">
                    <div class="flex-align flex-wrap gap-8">
                        <span class="text-main-600 bg-main-50 w-44 h-44 rounded-circle flex-center text-2xl flex-shrink-0"><i class="ph ph-key"></i></span>
                        <div>
                            <h6 class="mb-0">Class Access</h6>
                            <span class="text-13 text-gray-400">Manage user permissions</span>
                        </div>
                    </div>
                    <a href="class-access.php" class="text-gray-900 hover-text-main-600"><i class="ph ph-caret-right"></i></a>
                </div>
            </div>
        </div>
        <!-- Organization Activities End -->
