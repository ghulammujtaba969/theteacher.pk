   ...
   <div class="ibadat-inner-banner-main-wrapper">
      <div class="container custom-container">
         <div class="inner-page-title">
            <h2>Class-11 Syllabus</h2>
            <ul>
               <li><a href="Home.php">Home</a></li>
               <li><a href="javascript:;">| &nbsp; Class-11</a></li>
            </ul>
         </div>
      </div>
   </div>
...
echo ' >Detail
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="class-11.php?view=lessons" ';
if (LMS_VIEW == 'lessons') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
echo ' >Lessons
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="class-11.php?view=register" ';
...
echo ' >How To Register
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="class-11.php?view=videos" ';
if (LMS_VIEW == 'videos') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
if (!LMS_VIEW || LMS_VIEW == "detail") {
   include("include/Pages/class-11/detail-class-11.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "lessons") {
   include("include/Pages/class-11/lessons-class-11.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "register") {
   include("include/Pages/class-11/register-class-11.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "videos") {
   include("include/Pages/class-11/videos-class-11.php");
}
//-------------------------------------------------------
