   ...
   <div class="ibadat-inner-banner-main-wrapper">
      <div class="container custom-container">
         <div class="inner-page-title">
            <h2>Quranic-Grammer Syllabus</h2>
            <ul>
               <li><a href="Home.php">Home</a></li>
               <li><a href="javascript:;">| &nbsp; Quranic-Grammer</a></li>
            </ul>
         </div>
      </div>
   </div>
...
echo ' >Detail
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="quranic-grammer.php?view=lessons" ';
if (LMS_VIEW == 'lessons') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
echo ' >Lessons
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="quranic-grammer.php?view=register" ';
...
echo ' >How To Register
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="quranic-grammer.php?view=videos" ';
if (LMS_VIEW == 'videos') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
if (!LMS_VIEW || LMS_VIEW == "detail") {
   include("include/Pages/quranic-grammer/detail-quranic-grammer.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "lessons") {
   include("include/Pages/quranic-grammer/lessons-quranic-grammer.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "register") {
   include("include/Pages/quranic-grammer/register-quranic-grammer.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "videos") {
   include("include/Pages/quranic-grammer/videos-quranic-grammer.php");
}
//-------------------------------------------------------
