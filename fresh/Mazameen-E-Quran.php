   ...
   <div class="ibadat-inner-banner-main-wrapper">
      <div class="container custom-container">
         <div class="inner-page-title">
            <h2>Mazameen-E-Quran Syllabus</h2>
            <ul>
               <li><a href="Home.php">Home</a></li>
               <li><a href="javascript:;">| &nbsp; Mazameen-E-Quran</a></li>
            </ul>
         </div>
      </div>
   </div>
...
echo ' >Detail
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="Mazameen-E-Quran.php?view=lessons" ';
if (LMS_VIEW == 'lessons') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
echo ' >Lessons
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="Mazameen-E-Quran.php?view=register" ';
...
echo ' >How To Register
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="Mazameen-E-Quran.php?view=videos" ';
if (LMS_VIEW == 'videos') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
if (!LMS_VIEW || LMS_VIEW == "detail") {
   include("include/Pages/Mazameen-E-Quran/detail-Mazameen-E-Quran.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "lessons") {
   include("include/Pages/Mazameen-E-Quran/lessons-Mazameen-E-Quran.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "register") {
   include("include/Pages/Mazameen-E-Quran/register-Mazameen-E-Quran.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "videos") {
   include("include/Pages/Mazameen-E-Quran/videos-Mazameen-E-Quran.php");
}
//-------------------------------------------------------
