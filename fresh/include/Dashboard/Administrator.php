<?php 
//------------------------------------------------------
	$sqllmsTotalEmployees  	= $dblms->querylms("SELECT COUNT(id) AS TotalEmployees FROM ".EMPLOYEES." WHERE print_status = '1' ");
	$valueTotalEmployees	= mysqli_fetch_array($sqllmsTotalEmployees);
//------------------------------------------------------
	$sqllmsTotalMale  	= $dblms->querylms("SELECT COUNT(id) AS TotalMale FROM ".EMPLOYEES." WHERE print_status = '1' AND gender = 'Male' ");
	$valueTotalMale	= mysqli_fetch_array($sqllmsTotalMale);
//------------------------------------------------------
	$sqllmsTotalFemale  	= $dblms->querylms("SELECT COUNT(id) AS TotalFemale FROM ".EMPLOYEES." WHERE print_status = '1' AND gender = 'Female' ");
	$valueTotalFemale	= mysqli_fetch_array($sqllmsTotalFemale);
//------------------------------------------------------
echo'
