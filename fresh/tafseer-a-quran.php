   ...
   <div class="ibadat-inner-banner-main-wrapper">
      <div class="container custom-container">
         <div class="inner-page-title">
            <h2>Tafseer-a-Quran Syllabus</h2>
            <ul>
               <li><a href="Home.php">Home</a></li>
               <li><a href="javascript:;">| &nbsp; Tafseer-a-Quran</a></li>
            </ul>
         </div>
      </div>
   </div>
...
echo ' >Detail
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="tafseer-a-quran.php?view=lessons" ';
if (LMS_VIEW == 'lessons') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
echo ' >Lessons
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="tafseer-a-quran.php?view=register" ';
...
echo ' >How To Register
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="tafseer-a-quran.php?view=videos" ';
if (LMS_VIEW == 'videos') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
if (!LMS_VIEW || LMS_VIEW == "detail") {
   include("include/Pages/tafseer-a-quran/detail-tafseer-a-quran.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "lessons") {
   include("include/Pages/tafseer-a-quran/lessons-tafseer-a-quran.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "register") {
   include("include/Pages/tafseer-a-quran/register-tafseer-a-quran.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "videos") {
   include("include/Pages/tafseer-a-quran/videos-tafseer-a-quran.php");
}
//-------------------------------------------------------
