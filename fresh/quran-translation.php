   ...
   <div class="ibadat-inner-banner-main-wrapper">
      <div class="container custom-container">
         <div class="inner-page-title">
            <h2>Quran-Translation Syllabus</h2>
            <ul>
               <li><a href="Home.php">Home</a></li>
               <li><a href="javascript:;">| &nbsp; Quran-Translation</a></li>
            </ul>
         </div>
      </div>
   </div>
...
echo ' >Detail
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="quran-translation.php?view=lessons" ';
if (LMS_VIEW == 'lessons') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
echo ' >Lessons
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="quran-translation.php?view=register" ';
...
echo ' >How To Register
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="quran-translation.php?view=videos" ';
if (LMS_VIEW == 'videos') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
if (!LMS_VIEW || LMS_VIEW == "detail") {
   include("include/Pages/quran-translation/detail-quran-translation.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "lessons") {
   include("include/Pages/quran-translation/lessons-quran-translation.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "register") {
   include("include/Pages/quran-translation/register-quran-translation.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "videos") {
   include("include/Pages/quran-translation/videos-quran-translation.php");
}
//-------------------------------------------------------
