...
echo '
   ...
   <!--  -->
   <div class="ibadat-about-text-main-wrapper">
      <div class="container custom-container">
         <div class="about-inner-wrapper">
            <div class="abt-img">
               <img src="assets/images/home/about1.png" alt="img">
            </div>
            <div class="about-text-wrappper">
               <div class="left-title wow fadeInUp" data-wow-delay="100ms">
               ...
               <div class="about-mission-wrapper wow fadeInUp" data-wow-delay="200ms">
                  <div class="about-mission">
                     ...
                     <div class="mission-content">
                        <p>The fundamental purpose of “The Teacher” is to make ancient Islamic sciences and arts more accessible and understandable to society through the best, simple, and multimedia teaching methods.</p>

                        <p class="mt-2">In our society, there are two teaching methods being used: 1st one is the lecture method where a teacher with his physical appearance conducts a lecture in the classroom, and the other one is online teaching method where a teachers record his lectures and upload them on various sites, channels, and so many other platforms, which is no doubt beneficial for thousands of students. </p>
                     </div>
                  </div>
                  <div class="about-mission">
                     <div class="mission-icon-wrapper">
                     ...
                     <div class="mission-content">
                        <p>The primary goal of The Teacher\'s teaching method is to teach the translation of the Quran in such a simple and easy way that even a student in the primary class can understand the translation of the Holy Quran.</p>
                        
                        <p class="mt-2">The ultimate goal of The Teacher is to cresa a level of Quranic understanding where each individual in our society can understand the meaning of every word of the Quran (the purpose and the intent of the words of Allah SWT) comprehensively.</p>
                     </div>
                  </div>
               </div>
            </div>
