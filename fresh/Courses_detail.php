...
echo ' >Detail
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="Courses_detail.php?view=lessons" ';
if (LMS_VIEW == 'lessons') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
echo ' >Lessons
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="Courses_detail.php?view=register" ';
...
echo ' >How To Register
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="Courses_detail.php?view=videos" ';
if (LMS_VIEW == 'videos') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
if (!LMS_VIEW || LMS_VIEW == "detail") {
   include("include/Pages/Courses_detail/detail-Courses_detail.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "lessons") {
   include("include/Pages/Courses_detail/lessons-Courses_detail.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "register") {
   include("include/Pages/Courses_detail/register-Courses_detail.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "videos") {
   include("include/Pages/Courses_detail/videos-Courses_detail.php");
}
//-------------------------------------------------------
