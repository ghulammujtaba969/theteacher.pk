...
echo ' >Detail
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="class-8.php?view=lessons" ';
if (LMS_VIEW == 'lessons') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
echo ' >Lessons
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="class-8.php?view=register" ';
...
echo ' >How To Register
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="class-8.php?view=videos" ';
if (LMS_VIEW == 'videos') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
if (!LMS_VIEW || LMS_VIEW == "detail") {
   include("include/Pages/class-8/detail-class-8.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "lessons") {
   include("include/Pages/class-8/lessons-class-8.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "register") {
   include("include/Pages/class-8/register-class-8.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "videos") {
   include("include/Pages/class-8/videos-class-8.php");
}
//-------------------------------------------------------
