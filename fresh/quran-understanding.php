<?php
define('TITLE', 'Quran-Translation');
//--------------------------------------------------
   ...
   <div class="ibadat-inner-banner-main-wrapper">
      <div class="container custom-container">
         <div class="inner-page-title">
            <h2>Understanding of the Quran Syllabus</h2>
            <ul>
               <li><a href="Home.php">Home</a></li>
               <li><a href="javascript:;">| &nbsp; Understanding of the Quran</a></li>
            </ul>
         </div>
      </div>
   </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
               ...
               <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab-three" role="tablist">
                  <li class="nav-item" role="presentation">
                     <a href="quran-understanding.php" ';
if (!LMS_VIEW) {
...
echo ' >Detail
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="quran-understanding.php?view=lessons" ';
if (LMS_VIEW == 'lessons') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
echo ' >Lessons
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="quran-understanding.php?view=register" ';
...
echo ' >How To Register
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="quran-understanding.php?view=videos" ';
if (LMS_VIEW == 'videos') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
if (!LMS_VIEW || LMS_VIEW == "detail") {
   include("include/Pages/quran-understanding/detail-quran-understanding.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "lessons") {
   include("include/Pages/quran-understanding/lessons-quran-understanding.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "register") {
   include("include/Pages/quran-understanding/register-quran-understanding.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "videos") {
   include("include/Pages/quran-understanding/videos-quran-understanding.php");
}
//-------------------------------------------------------
