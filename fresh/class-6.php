...
<!-- inner- slider -->
   ...
   <div class="tab-three-wrapper w-100 pt-3" style="background-color: #f8f2e8;">
      <div class="container">
         <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
               <img class="imges" id="bar-img-ro" src="assets/images/home/line.png" alt="">
...
echo ' >Detail
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="class-6.php?view=lessons" ';
if (LMS_VIEW == 'lessons') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
echo ' >Lessons
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="class-6.php?view=register" ';
...
echo ' >How To Register
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="class-6.php?view=videos" ';
if (LMS_VIEW == 'videos') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
echo ' >Videos
               ...
               <img class="imges-2" id="bar-img" src="assets/images/home/line.png" alt="">
            </div>
         </div>
      </div>
   </div>
...
if (!LMS_VIEW || LMS_VIEW == "detail") {
   include("include/Pages/class-6/detail-class-6.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "lessons") {
   include("include/Pages/class-6/lessons-class-6.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "register") {
   include("include/Pages/class-6/register-class-6.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "videos") {
   include("include/Pages/class-6/videos-class-6.php");
}
//-------------------------------------------------------
