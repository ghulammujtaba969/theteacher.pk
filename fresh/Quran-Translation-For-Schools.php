<?php
define('TITLE', 'Quran-Translation-For-Schools');
//--------------------------------------------------
   ...
   <div class="ibadat-inner-banner-main-wrapper">
      <div class="container custom-container">
         <div class="inner-page-title">
            <h2>Quran-Translation-For-Schools Syllabus</h2>
            <ul>
               <li><a href="Home.php">Home</a></li>
               <li><a href="javascript:;">| &nbsp; Quran-Translation-For-Schools</a></li>
            </ul>
         </div>
      </div>
   </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
               ...
               <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab-three" role="tablist">
                  <li class="nav-item" role="presentation">
                     <a href="Quran-Translation-For-Schools.php" ';
if (!LMS_VIEW) {
...
echo ' >Detail
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="Quran-Translation-For-Schools.php?view=lessons" ';
if (LMS_VIEW == 'lessons') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
echo ' >Lessons
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="Quran-Translation-For-Schools.php?view=register" ';
...
echo ' >How To Register
                  ...
                  <li class="nav-item" role="presentation">
                     <a href="Quran-Translation-For-Schools.php?view=videos" ';
if (LMS_VIEW == 'videos') {
   echo 'class="nav-link active"';
} else {
   echo 'class="nav-link"';
...
if (!LMS_VIEW || LMS_VIEW == "detail") {
   include("include/Pages/Quran-Translation-For-Schools/detail-Quran-Translation-For-Schools.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "lessons") {
   include("include/Pages/Quran-Translation-For-Schools/lessons-Quran-Translation-For-Schools.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "register") {
   include("include/Pages/Quran-Translation-For-Schools/register-Quran-Translation-For-Schools.php");
}
//-------------------------------------------------------
if (LMS_VIEW == "videos") {
   include("include/Pages/Quran-Translation-For-Schools/videos-Quran-Translation-For-Schools.php");
}
//-------------------------------------------------------
