               ...
               <div class="row">
                  <div class="col-lg-7 col-md-7">
                        <div class="slider-content s-slider-content mt-130">
                            ...
                            <h2 data-animation="fadeInUp" data-delay=".2s">{{ $slider['sub_heading'] }}</h2>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="courses-item mb-30 hover-zoomin @if($gsetting['course_hover'] == 1) protip @endif">
                    ...
                    <div class="courses-content">    
                        ...
                        <h3><a href="{{ route('user.course.show',['id' => $discount->id, 'slug' => $discount->slug ]) }}"> {{$discount->category['title'] ?? '-'}}</a></h3>
        ...
        <div class="row class-active">
            ...
            <div class="col-lg-4 col-md-6 ">
                ...
                <div class="class-item mb-30 courses-item hover-zoomin">
                    ...
                    <div class="class-img">
                        <div class="class-img-outer">
                            <a href="{{ route('ins.sluging', ['id' => $inst->id, 'slug' => $inst->slug]) }}"> <img src="{{ $inst['image'] ? url('/files/institute/'.$inst->image) : Avatar::create($inst->fname)->toBase64() }}" alt="class image"></a>
                            <div class="courses-icon">
                                <ul>
                                    <li>
                                        <a href="{{ route('ins.sluging', ['id' => $inst->id, 'slug' => $inst->slug]) }}"  title="View Page"><i data-feather="eye"></i></a>
                                    </li>
                                </ul>
                            </div>
                            <!-- course-meta -->
