                                        ...
                                        <div class="img-wishlist">
                                            <div class="protip-wishlist">
                                                <ul>
                                                    ...
                                                    @else
                                                        <li class="protip-wish-btn">
                                                            <a href="{{ route('login') }}" title="heart"><i data-feather="heart"></i></a>
                                                        </li>
                                                    @endif
                                                </ul>
                                            </div>
            ...
            <div class="item student-view-block student-view-block-1">
                <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif"
                    ...
                    <div class="view-block">
                        ...
                        <div class="view-user-img">
                            <a href="{{ route('all/profile', $bundle->user->id) }}" title="">
                                <img src="{{ asset($bundle->user->user_img ? 'images/user_img/' . $bundle->user->user_img : 'images/default/user.png') }}" class="img-fluid user-img-one" alt="">
                            </a>
                        </div>
                        <div class="view-dtl">
                            <div class="view-heading"><a
        ...
        <div id="bestseller-view-slider" class="student-view-slider-main-block owl-carousel">
            ...
            <div class="item student-view-block student-view-block-1">
                <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif"
                    ...
                    <div class="view-block">
                        <div class="view-img">
                            <a href="{{ route('user.course.show', ['id' => $best->courses->id, 'slug' => $best->courses->slug]) }}">
                    ...
                    @endif
                        <div class="view-user-img">
                            <a href="{{ route('all/profile', $best->courses->user->id) }}" title="">
                                <img src="{{ asset($best->courses->user->user_img ? 'images/user_img/' . $best->courses->user->user_img : 'images/default/user.png') }}" class="img-fluid user-img-one" alt="">
                            </a>
                        </div>                        
                        <div class="view-dtl">
            ...
            <div class="item">
                <div class="instructor-home-block text-center">
                    <div class="instructor-home-block-one">
                        ...
                        <a href="{{ route('allinstructor/profile',$inst->id) }}" title="">
                            <img src="{{ $userImg ? url('/images/user_img/'.$userImg) : Avatar::create($inst->user->fname)->toBase64() }}" class="img-fluid" />
                        </a>
                        ...
                        <div class="instructor-home-dtl">
                            <h4 class="instructor-home-heading"><a href="#" title="">{{ $fullName }}</a></h4>
                            <p>{{ $inst->role }}</p>
...
<section id="student" class="student-main-block">
                ...
                <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif"
                    ...
                    <div class="view-img">
                        ...
                        <div class="view-user-img">
                            ...
                            <a href="{{ route('all/profile', $userId) }}" title="">
                                <img src="{{ $imgSrc }}" class="img-fluid user-img-one" alt="">
                            </a>
                        </div>
                                            <div class="tooltip">
                            <div class="tooltip-icon">
    ...
    @endphp
    <a href="{{ $route }}">{{ $heading }}</a>
</div>
                            <div class="user-name">
    <h6>By <span><a href="{{ route('all/profile', optional($blog->user)->id) }}">{{ optional($blog->user)->fname }}</a></span></h6>
</div>
                           <div class="view-footer">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                        ...
                        <div id="recommendations-slider" class="recommendations-main-slider owl-carousel">
                            <div class="item">
                                <div class="recommendations-img">
                                    <img src="{{ $gets['img'] ? url('/images/joininstructor/'.$gets->img) : Avatar::create($gets->text)->toBase64() }}" height="100px" width="100px">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="service-side-img">
                        <img src="{{ $servicesetting['image'] ? asset('images/services/'.$servicesetting['image']) : Avatar::create($servicesetting->title)->toBase64() }}" class="img-fluid" alt="">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="service-block">
                                    <div class="service-img text-center">
                                        <img src="{{ $ser['image'] ? asset('images/services/'.$ser['image']) : Avatar::create($ser->title)->toBase64() }}" class="img-fluid" alt="">
                                    </div>
...
@if($hsetting->video_enable == 1 && isset($videosetting))
    <section id="video" class="video-main-block">
        <div class="container-fluid p-0">
            <div class="video-block parallax" style="background-image: url({{ $videosetting['image'] ? 'images/videosetting/'.$videosetting->image : Avatar::create($videosetting->tittle)->toBase64() }});">
                <div class="overlay-bg"></div>
            </div>
                    ...
                    <div class="instructor-home-block-one">
                        ...
                        <div class="instructor-home-dtl">
                            <h4 class="instructor-home-heading">
                                <a href="{{ route('allinstructor/profile',$inst->id) }}" title="">{{ $inst->fname }} {{ $inst->lname }}</a>
                            </h4>
                            <p>{{ $inst->role }}</p>
                            @php
                                $followers = App\Followers::where('user_id', '!=', $inst->id)->where('follower_id', $inst->id)->count();
    ...
    <div class="container-xl">
        ...
        <div id="institute-home-slider" class="instructor-home-main-slider owl-carousel">
            ...
            <div class="item">
                <div class="instructor-home-block text-center">
                    <div class="instructor-home-block-one">
                        <a href="{{ route('ins.sluging', ['id' => $inst->id, 'slug' => $inst->slug]) }}" title="">
        ...
        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="feature-dtl-icon">
                                <img src="{{ $data['image'] ? asset('images/feature/'.$data['image']) : Avatar::create($data->title)->toBase64() }}" class="img-fluid" alt="">
                            </div>
            ...
            <div class="col-lg-5 col-md-5">
                <div class="feature-image">
                    <img src="{{ $featuresetting['image'] ? asset('images/feature/'.$featuresetting['image']) : Avatar::create($featuresetting->title)->toBase64() }}" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </div>
