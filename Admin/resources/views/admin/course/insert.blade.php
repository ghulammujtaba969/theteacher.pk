          ...
          <form action="{{url('course/')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="title" class="form-control" name="title" value ="{{ old('title') }}" id="exampleInputTitle" placeholder="{{ __('Enter Course Name') }}" value="{{ (old('title')) }}" required>
              </div>
              <div class="col-md-6">
                <label for="exampleInputSlug">{{ __('Slug') }}: <sup class="redstar">*</sup></label>
                <input pattern="[/^\S*$/]+" type="text" class="form-control" name="slug" value ="{{ old('slug') }}" id="exampleInputPassword1" placeholder="{{ __('Enter Slug') }}" value="{{ (old('slug')) }}" required>
              </div>
            </div>
            <br>
