...
class CareersController extends Controller
{
    ...
    public function update(Request $request)
    {
        $data = $this->validate($request,[
            'three_bg_image' => 'image|mimes:jpg,jpeg,png',
            'four_img_one' => 'image|mimes:jpg,jpeg,png',
            'four_img_two' => 'image|mimes:jpg,jpeg,png',
            'four_img_three' => 'image|mimes:jpg,jpeg,png',
            'four_img_four' => 'image|mimes:jpg,jpeg,png',
            'four_img_five' => 'image|mimes:jpg,jpeg,png',
            'four_img_six' => 'image|mimes:jpg,jpeg,png',
            'four_img_seven' => 'image|mimes:jpg,jpeg,png',
            'four_img_eight' => 'image|mimes:jpg,jpeg,png',
            'four_img_nine' => 'image|mimes:jpg,jpeg,png',
        ]);
    ...
    public function careerpage()
    {
        ...
        return view('quedecato.front.careers',compact('data'));
