...
class InstructorPlanController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'title' => 'required',
            'detail' => 'required',
            'preview_image' => 'image|mimes:jpg,jpeg,png',
        ]);
    ...
    public function planpage()
    {
        ...
        return view('quedecato.front.plan.view', compact('plans', 'subscribed'));
    ...
    public function checkout(Request $request)
    {
        ...
        return view('quedecato.front.plan.plan_checkout', compact('plans'));
