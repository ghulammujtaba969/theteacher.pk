...
class CourseController extends Controller
{
    ...
    if (Auth::check()) {
      ...
      if (!empty($bundle_check)) {
        ...
        if (Auth::user()->role == 'user') {
          ...
          return view('quedecato.front.course_detail', compact('course', 'courseinclude', 'whatlearns', 'coursechapters', 'courseclass', 'coursereviews', 'reviews', 'relatedcourse', 'course_id', 'ad', 'bigblue', 'meetings', 'googlemeetmeetings', 'jitsimeetings', 'order', 'wish', 'currency', 'cart', 'instruct_course'));
        } else {
          return view('quedecato.front.course_detail', compact('course', 'courseinclude', 'whatlearns', 'coursechapters', 'courseclass', 'coursereviews', 'reviews', 'relatedcourse', 'ad', 'bigblue', 'meetings', 'googlemeetmeetings', 'jitsimeetings', 'order', 'wish', 'currency', 'cart', 'instruct_course'));
        }
      } else {
  ...
  public function CourseContentPage($id, $slug)
  {
    ...
    if (Auth::check()) {
      ...
      return view('quedecato.front.course_content', compact('course', 'coursequestions', 'announsments', 'progress', 'assignment', 'appointment', 'bigblue', 'meetings', 'googlemeetmeetings', 'jitsimeetings', 'papers','certificate_setting'));
  ...
  public function mycoursepage()
  {
    if (Auth::check()) {
      ...
      return view('quedecato.front.my_course', compact('course', 'enroll'));
    }
  ...
  public function Allcourse(){
    ...
    return view('quedecato.front.allcourse',compact('data'));  }
