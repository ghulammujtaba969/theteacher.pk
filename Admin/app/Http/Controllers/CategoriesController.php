...
class CategoriesController extends Controller
{
  ...
  public function store(Request $request)
  {
    $data = $this->validate($request, [
      ...
      "slug" => "required",
      "icon" => "required",
      "cat_image" => "required|image|mimes:jpg,jpeg,png",
    ]);
  ...
  public function categoryPage(Request $request)
  {
    ...
    return view('quedecato.front.category', compact('cats', 'courses', 'subcat', 'filter_count', 'usercountry'));
  ...
  public function subcategoryPage(Request $request)
  {
    ...
    return view('quedecato.front.category', compact('cats', 'courses', 'childcat', 'filter_count', 'usercountry'));
  }
  ...
  return view('quedecato.front.category', compact('cats', 'courses', 'filter_count', 'usercountry'));
