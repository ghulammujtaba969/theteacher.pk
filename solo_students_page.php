        ...
        switch ($_POST['action']) {
            case 'assign_classes':
                ...
                if (isset($_POST['selected_students']) && isset($_POST['selected_classes'])) {
                    ...
                    if ($success_count > 0) {
                        $message = "Successfully assigned $success_count out of $total_assignments class assignments.";
                    } else {
...
$solo_students = getSoloStudents($db);
...
<!--==================== Sidebar Overlay End ====================-->
            ...
            <div class="card overflow-hidden">
                <div class="card-body p-0 overflow-x-auto">
                    <table id="soloStudentsTable" class="table table-striped">
                        ...
                        <tbody>
                            <?php foreach ($solo_students as $student): ?>
                            <tr data-class-count="<?php echo $student['class_count']; ?>">
                                ...
                                <td>
                                    <div class="flex-align gap-8">
                                        <img src="assets/images/thumbs/user-img.png" alt="" class="w-40 h-40 rounded-circle">
                                ...
                                <td>
                                    <span class="h6 mb-0 fw-medium text-gray-300">@<?php echo htmlspecialchars($student['username']); ?></span>
                                </td>
                                <td>
                ...
                <div class="card-footer flex-between flex-wrap">
                    <span class="text-gray-900">Showing <span id="showing-count"><?php echo count($solo_students); ?></span> of <?php echo count($solo_students); ?> solo students</span>
            ...
            <div class="modal-content">
                <form method="POST" id="assignClassForm">
                    <div class="modal-header">
                        <h5 class="modal-title">Assign Classes to Students</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="selectedStudentsList" class="border rounded p-3 bg-light"></div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="selected_classes[]" value="<?php echo $class['id']; ?>" id="class_<?php echo $class['id']; ?>">
    ...
    <div class="modal fade" id="studentClassesModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="studentClassesModalTitle">Student Classes</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body" id="studentClassesContent">
